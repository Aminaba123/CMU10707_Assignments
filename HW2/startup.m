...
function startup()
	...
	addpath(genpath(fullfile(curdir, 'xinshuo_toolbox', 'xinshuo_learning', 'restricted_boltzmann_machine')));
	addpath(genpath(fullfile(curdir, 'xinshuo_toolbox', 'xinshuo_learning', 'auto_encoder')));
